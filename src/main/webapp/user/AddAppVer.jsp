...
<form class="layui-form" action="/addVer" method="post">
    <div class="layui-form-item">
        <label class="layui-form-label">版本号*</label>
        <div class="layui-input-inline">
            <input type="text" name="versionno" required  lay-verify="required" autocomplete="off" class="layui-input" value="">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">版本大小*</label>
        <div class="layui-input-inline">
            <input type="text" name="versionsize" required  lay-verify="required"  autocomplete="off" class="layui-input" value="">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">发布状态*</label>
        <div class="layui-input-inline">
            <input type="text" value="预发布" style="border: 0px none" readonly="readonly">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <textarea name="versioninfo" required lay-verify="required"  class="layui-textarea"></textarea>
        </div>
    </div>
    <div class="layui-form-item" id="fileUp">
        ...
        <div class="layui-input-inline">
            ...
            <input type='hidden' value="" name='downloadlink' id='downloadlink'>
        </div>
    </div>
    <div>
