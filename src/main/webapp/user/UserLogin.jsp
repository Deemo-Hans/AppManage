...
<div class="layui-bg-cyan layui-row">
 <div class="layui-col-xs12 layui-col-md12 layui-col-lg-offset4" style="height:40px;"><span style="font-size: 20px;">欢迎使用APP管理系统(开发者)</span> </div>
</div>
<!--head end-->
<%--    表单部分--%>
<div class="layui-row">
    <div class="layui-col-xs12 layui-col-md12 layui-col-lg-offset4" style="padding-top: 20px;">
        <form class="layui-form" action="/devUserCheck" method="post" onsubmit="return checkSub()">
            <div class="layui-form-item">
                <label class="layui-form-label"><i class="layui-icon layui-icon-username" style="font-size: 20px; color: black;"></i></label>
                <div class="layui-input-inline">
                    <input type="text" name="devcode" required  lay-verify="required" placeholder="用户名" autocomplete="off" class="layui-input" name="username" id="username"
                    onblur="checkUname()">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="password" name="devpassword" required lay-verify="required" placeholder="请输入密码" autocomplete="off" class="layui-input" name="password" id="password"
                           onblur="checkPwd()">
